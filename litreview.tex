...
Since the original service models were penned, there have been many other types services models introduced. Several of these focus on IoT service layers as noted by Botta et al's\cite{botta_integration_2016}. These include \textbf{Sensing as a Service} (S$^2$aaS), \textbf{Sensing and Actuation as a Service} (SAaaS), \textbf{Sensor Event as a Service} (SEaaS), \textbf{Sensor as a Service} (SenaaS), \textbf{Data Base as a Service} (DBaaS), \textbf{Data as a Service} (DaaS), \textbf{Ethernet as a Service} (EaaS), \textbf{Idendity and Policy Management as a Service} (IPMaaS), and \textbf{Video Surveillance as a Service} (VSaaS).

Some of the above mentioned service models are of particular interest for a survey examining cloud computing and sensor networks.
