...
\vspace*{\fill}
\begin{center}
    \textit{To my adviser Philip.\\Thanks for the patience.}
\end{center}
\vspace*{\fill}
\pagebreak
...
\subsection{The Three (Four and Five) ``V's"}\label{ssec:four-vs}
...
FlockDB is a specialized graph database created for managing relationship data at Twitter. There is not a ton of academic information of whitepapers, but it is described by Hecht and Jablonksi in literature\cite{hecht_nosql_2011} and you can also find some information on their github \url{https://github.com/twitter/flockdb}.
...
\subsection{Misc.}\label{ssec:misc}
