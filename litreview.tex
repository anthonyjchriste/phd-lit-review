...
The Whitehouse report on big data\cite{pcast}, in 2014, defines big data as "data that isso large in volume, so diverse in variety or moving with such velocity,that traditional modes of data capture and  analysis  are  insufficient" and 
...
The definition of the 4 V's have been updated over the years in the following ways. The volume is data is expanding faster than ever before. 
